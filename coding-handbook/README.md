...
| Chapter | Book Topic | Code Directory | Key Files |
|---------|-----------|---------------|-----------|
| **Ch 5** | [Embeddings & Asymmetric Search](../book/chapter_5_embeddings.md) | [`ch05_embeddings/`](./ch05_embeddings/) | `asymmetric_embedding_search.py` |
| **Ch 6** | [Building a Vector Database](../book/chapter_6_vector_db.md) | [`ch06_vector_db/`](./ch06_vector_db/) | `hnsw_from_scratch.py`, `ast_code_chunker.py` |
...
| Chapter | Book Topic | Code Directory | Key Files |
|---------|-----------|---------------|-----------|
| **Ch 8** | [The Code Interpreter](../book/chapter_8_code_interpreter.md) | [`ch08_code_interpreter/`](./ch08_code_interpreter/) | `microvm_sandbox_executor.py` |

### Part V: Advanced Orchestration

| Chapter | Book Topic | Code Directory | Key Files |
|---------|-----------|---------------|-----------|
| **Ch 9** | [Model Context Protocol](../book/chapter_9_mcp.md) | [`ch09_mcp/`](./ch09_mcp/) | `mcp_json_rpc_server.py` |
| **Ch 10** | [Multi-Agent State Machines](../book/chapter_10_multi_agent.md) | [`ch10_multi_agent/`](./ch10_multi_agent/) | `dag_state_machine.py`, `checkpoint_serializer.py` |
...
| Chapter | Book Topic | Code Directory | Key Files |
|---------|-----------|---------------|-----------|
| **Ch 13** | [Enterprise Architectures](../book/chapter_13_enterprise.md) | [`ch13_enterprise_architectures/`](./ch13_enterprise_architectures/) | *(architecture-focused — see diagrams in book)* |
...
| **Ch 15** | [Observability & Tracing](../book/chapter_15_observability.md) | [`ch15_observability/`](./ch15_observability/) | `otel_react_orchestrator.py`, `attention_analysis.py`, `prometheus_metrics.py` |
...
1. **Read the chapter** in the book (PDF or markdown)
2. **Open the corresponding code directory** here
3. **Read the chapter README** for context and learning goals
4. **Run the code** — every file is self-contained and documented
5. **Modify and experiment** — break things, add features, make it your own
...
|---------|---------------------|---------|
| OpenAI | `OPENAI_API_KEY` | Ch 3, 4, 5, 6, 14, 15, 16, 17, 18, 19, 21 |
| Anthropic | `ANTHROPIC_API_KEY` | Ch 16, 20 |
| GitHub | `GITHUB_TOKEN` | Ch 18 |
| ChromaDB | *(local, no key)* | Ch 6, 18 |

---

## 📄 License

This coding handbook is part of **The Practitioner's Handbook of Agentic AI**.  
All code is released under the MIT License for educational and commercial use.
